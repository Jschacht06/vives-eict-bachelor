...
void UpdateAPA102CLeds(SPI_HandleTypeDef* hspi, APA102C led[])
{
	...
	// HAL_SPI_Transmit_DMA(hspi, source, (4 + NUMBER_OF_APA102C_LEDS * 4 + 4)); (niet blokkerend)
	HAL_SPI_Transmit(hspi, source, (4 + NUMBER_OF_APA102C_LEDS * 4 + 4), 100); // wel blokkerend
}
