...
Create an application that calculates the first 20 numbers of the Fibonacci sequence and outputs them to the terminal. Calculate the sum of the numbers. It should be `17711`.
