...
namespace AppleCake
{
    public class AppleCakeGenerator
    {
        public string AppleCake(int value)
        {
            ...
            // Deze voorwaarde moet eerst anders is deze onbereikbaar als je eerst bv if (value % 3 == 0) eerst staat en het
            // is deelbaar door 3 dan zal de tekst "apple" worden en zal de rest van de if else statement niet meer gecontrolleer worden.
