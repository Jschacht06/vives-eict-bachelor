...
This repository contains the challenges that accompany the C\# course at VIVES University of Applied Sciences at Bruges which can be found at [https://from-bace-to-ace.netlify.app/](https://from-bace-to-ace.netlify.app/).
...
6. Copy the ssh clone-url (green button) that looks like `git@github.com:vives-intro-to-programming-2023-2024/assignments-<username>.git`
...
```bash
git remote add base git@github.com:vives-intro-to-programming-2023-2024/assignments.git
```

`base` is the name of remote repo. Now you should see two remotes when issuing the command `git remote -v`. For example:

```text
base     git@github.com:vives-intro-to-programming-2023-2024/assignments.git (fetch)
base     git@github.com:vives-intro-to-programming-2023-2024/assignments.git (push)
origin  git@github.com:vives-intro-to-programming-2023-2024/assignments-RonnyMees.git (fetch)
origin  git@github.com:vives-intro-to-programming-2023-2024/assignments-RonnyMees.git (push)
```
