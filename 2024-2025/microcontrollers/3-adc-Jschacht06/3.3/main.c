...
static uint16_t byteValue = 0;
static int maxValue = 0;
static uint8_t peakLed = 0;
...
int main(void)
{
	...
	{	
		adcValue = GetAdValue();
		byteValue = adcValue/16; //adcValue omzetten naar een byte waarde
		
		ByteToLevel(byteValue); //LEDS AAN
		
		maxValue = (adcValue/512)+1; //adcValue omzetten 
		...
		if ((ticks - peakTimer) < 1000 && peakLed > 0 && peakLed <= 8) 
		{
			//peak led aanzetten
			switch (peakLed)
			{
				case 1: GPIOC->ODR |= GPIO_ODR_0; break;
				case 2: GPIOB->ODR |= GPIO_ODR_3; break;
				case 3: GPIOB->ODR |= GPIO_ODR_5; break;
				case 4: GPIOB->ODR |= GPIO_ODR_4; break;
				case 5: GPIOB->ODR |= GPIO_ODR_10; break;
				case 6: GPIOA->ODR |= GPIO_ODR_8; break;
				case 7: GPIOC->ODR |= GPIO_ODR_7; break;
				case 8: GPIOB->ODR |= GPIO_ODR_6; break;
				default: break;
			}
		}
		else
		{
			//peak led terug uitzetten
			switch (peakLed)
			{
				case 1: GPIOC->ODR &= ~GPIO_ODR_0; break;
				case 2: GPIOB->ODR &= ~GPIO_ODR_3; break;
